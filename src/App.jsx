...
const FLAGS = {
  ...
  "México":"🇲🇽","Ecuador":"🇪🇨","Inglaterra":"🏴󠁧󠁢󠁥󠁮󠁧󠁿","R.D. Congo":"🇨🇩",
  "Bélgica":"🇧🇪","Senegal":"🇸🇳","EE.UU.":"🇺🇸","Bosnia y H.":"🇧🇦",
  "España":"🇪🇸","Austria":"🇦🇹","Argentina":"🇦🇷","Cabo Verde":"🇨🇻",
  "Colombia":"🇨🇴","Ghana":"🇬🇭","Australia":"🇦🇺","Egipto":"🇪🇬",
  "Portugal":"🇵🇹","Croacia":"🇭🇷","Suiza":"🇨🇭","Argelia":"🇩🇿",
};
...
const ROUNDS = [
  {
    ...
    label: "Dieciseisavos",
    emoji: "⚔️",
    deadline: new Date("2026-06-28T18:30:00Z"), // 28 jun 15:30hs ARG (30 min antes del primer partido)
    matches: [
      ...
      { id: "R1_08", h: "Inglaterra",    a: "R.D. Congo",     date: "01/07", venue: "Guadalajara" },
      { id: "R1_09", h: "Bélgica",       a: "Senegal",        date: "01/07", venue: "Seattle" },
      ...
      { id: "R1_13", h: "Portugal",      a: "Croacia",        date: "02/07", venue: "Toronto" },
      { id: "R1_14", h: "Australia",     a: "Egipto",         date: "03/07", venue: "Dallas" },
      { id: "R1_15", h: "Suiza",         a: "Argelia",        date: "02/07", venue: "Vancouver" },
      { id: "R1_16", h: "Colombia",      a: "Ghana",          date: "03/07", venue: "Kansas City" },
    ],
  },
  {
    id: "8vos",
